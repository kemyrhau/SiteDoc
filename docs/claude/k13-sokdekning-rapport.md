...
status: lukket 2026-07-11 (ffc703df), web-deployet test — skjermbilder/designgodkjenning eies av statuskilden `verifisering/K13-verifiseringslogg.md` (designprosjektet), ikke duplisert her
...
> **Skjermbilder + fabel-designgodkjenning:** eies av statuskilden `verifisering/K13-verifiseringslogg.md` (designprosjektet) — ikke duplisert her. Bildene ligger i `docs/claude/skjermbilder-k13/`.
