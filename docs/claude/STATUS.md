...
| parallell-arbeid-lock.md | 2026-07-05 | **Styrende:** Parallell-arbeid mellom worktrees/økter — 7 kjøreregler, frossen sone, /mannskap-kollisjon, 2 lærdommer (index.lock-diagnostikk + ukommittert-blokkerer-checkout→worktrees). Ny 2026-07-05. Indeksert i DOC-MAP (ikke CLAUDE.md-tabell pga 40k-grense — allerede lenket i kontroll-claude-veileder-raden) |
