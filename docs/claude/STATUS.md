...
| timer-gps-prosjekt-utredning.md | 2026-06-13 | **Arbeidsanker:** Session-klar agenda — 6 avhengighets-ordnede beslutninger rundt timer/GPS/prosjekt-tilknytning/dag-flyt (T.8 først). Samlet fra R4 + EAS-test 2026-06-13. Ingen kode før beslutninger. Relatert: BACKLOG § Timer-relatert T.8-utredning + fase-0 T.8 «under revurdering» |
