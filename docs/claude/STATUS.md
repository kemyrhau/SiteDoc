...
| parallell-arbeid-lock.md | 2026-07-06 | **Styrende:** Parallell-arbeid mellom worktrees/økter — 12 kjøreregler (bl.a. regel 9 `--no-ff`, regel 11 build-gate, regel 12 pre-push u-gatet-commit-sjekk), worktree-tabell, frossen sone, /mannskap-kollisjon, lærdommer. Ny 2026-07-05. Indeksert i DOC-MAP (ikke CLAUDE.md-tabell pga 40k-grense — allerede lenket i kontroll-claude-veileder-raden) |
