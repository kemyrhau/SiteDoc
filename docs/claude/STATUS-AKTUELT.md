...
> **Verifiseringsnivå:** SYNC-1, SYNC-2, M2, M3, M4 og M5 er **statisk verifisert** (typecheck, vitest, web-build, git-objekt-lesing). Ingen mobil-kode er eksekvert. Atferd på enhet/simulator er **ikke** bekreftet — se Fase 4-verifisering før EAS-bygg.
