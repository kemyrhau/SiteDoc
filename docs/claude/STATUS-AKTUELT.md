...
### Del-6-fiksrunde F-b/F-e/F-f/F-g — branch `fix/del6-fbefg`, venter cowork-gate (2026-07-13)
...
- Typecheck 0 nye feil (shared 9=9, api grønt, web 4=4 vitest-baseline, mobil 11=11). i18n generate → 13 språk. **Aksept: fabel live-fangst per fiks (batches med S-A M-3-reprise etter deploy).**

### hentEndringerSiden «erstattet»-lekkasje → historikk-tabell (fiks B) — FULLT TEST-VERIFISERT (M-1+M-2 PASS), venter prod spor b (2026-07-13)
