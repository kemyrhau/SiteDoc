...
|---|---|---|---|---|---|
| **Utlegg-ordningsmodell** | `SiteDoc-utlegg` | `feat/utlegg-ordningsmodell` | `packages/shared/src/utils/utleggOrdning.ts` · `apps/api/src/routes/timer/expenseCategory.ts` · `apps/web/.../timer/[id]/page.tsx` · `docs/claude/timer.md` | 2026-08-08 | 🟢 **U1 prod (`e37621e1`). U3 web MERGET develop** — U1-migrering + CHECK-bevis verifisert på test (alle fire tilfeller). E2E kan kjøres. U2 utsatt (ingen Proadm-eksportmotor i kode). Neste: E2E → U4 mobil (bygg 45) |
