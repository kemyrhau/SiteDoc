...
- **Gjenstår i køen:** «Du har ballen — {merke}»-mikrotekst (kosmetisk) · **Fase 5b** (Playwright UI-e2e — server + ny klient ende-til-ende) · **DEPLOY-GATE utvidet:** live-verifiser Send-fra-received + trekk-tilbake på test-DB ved neste test-deploy. **Flytmodell-Opus compacter her — gjenoppta fra denne entryen + `relay/STATUS.md`.**
