...
- **P4a mobil iOS-modal** (branch `feat/p4a-ios-modal`, `7d19e3ea` — PÅ BRANCH, venter Kenneth fysisk iOS-test): serialiser `<Modal onDismiss>` + skip modal ved entydig kontekst. GPS best-effort. Foundation for mobil opprett-flyt.
