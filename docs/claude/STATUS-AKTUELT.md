...
| **T4-d** | ⏳ Planlagt | Mobil Drizzle — fraTid/tilTid på sheet_timer_local + sheet_machine_local + arbeidstidskalender_local (= T9d) + organizationSettingLocal + kalender-katalog-service + timerSync push/pull. |
