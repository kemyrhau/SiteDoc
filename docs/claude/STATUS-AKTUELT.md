...
2. **i18n-utvidelse til 13 språk** — totalt **15 språk** konfigurert: en (master, 2 328 nøkler), nb (2 328), og 13 andre (cs/de/et/fi/fr/lt/lv/pl/ro/ru/sq/sv/uk, 2 298 hver). 30 nøkler fra T7-4f → T7-5e + `nyttProsjekt.ingenFirma` mangler i de 13. Håndteres av auto-oversettings-skriptet ved neste batch.
