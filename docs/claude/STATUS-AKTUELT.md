...
|---|---|---|---|---|
| M-3a **del 1** — felttype-matrise (KUN lesing) | `SiteDoc-fratil` | `docs/faseM-3a-matrise` | `docs/claude/faseM-3a-felttype-matrise.md` (ny). **Del 2 sperret.** Ingen kode · ingen i18n (redesign eier `nb/en.json`) · ingen dev-server (redesign eier `localhost:3100`) | åpnes |
