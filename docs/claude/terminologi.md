...
- **Snapshot-pattern:** Felter som fryser data ved en hendelse for å unngå at endringer i kilden påvirker historikk. Eksempler: `document_transfers.senderFaggruppeName`, `attestertSnapshot.prisMotKunde` på timer-rader, `actorNavnSnapshot` på Activity. Brukt overalt der historisk integritet er kritisk
