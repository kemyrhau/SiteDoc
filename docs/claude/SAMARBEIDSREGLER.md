...
| **fabel** | Eier redesignet. Skriver ordre til redesign-Opus (hva kodes, designkrav, akseptkriterier), designgodkjenner mot handoff-spec + skjermbilder, bestiller verifisering fra Opus web. **Rører aldri git-koreografi.** | Nei | redesign-retning |
