...
### Slice 4 — dag-grense + nattskift + glemt-dag + system-flagg + arbeidstids-varsel 🟡 (4a ✅ develop 2026-06-20, 4b ikke startet)
...
**Gjenstår = 4b (server-migrering, GATED):** Lag 2 (glemt-dag-prompt) + Lag 3 (`sluttTidKilde`) + arbeidstids-varsel. Detaljer under.
