...
### Slice 4 — dag-grense + nattskift + glemt-dag + system-flagg + arbeidstids-varsel 🟡 (4a ✅ + 4b-1 ✅ develop 2026-06-20, 4b-2 gated/ikke startet)
...
- **4b-2 — Lag 3 (`sluttTidKilde`) + arbeidstids-varsel (GATED, ikke startet):** krever server-migrering. All migrerings-avhengig kode samlet her. Detaljer under.
