...
**⚠️ Follow-up (Kenneth-hånd, egen sak):** `~/cruft-quarantine/` inneholder **sensitivt** materiale (`.ssh`-kopi, LUKS-header, `sitedoc-*.env`). Skal sikres/slettes **etter** at aktive kopier er bekreftet intakte. Ikke slett blindt.
