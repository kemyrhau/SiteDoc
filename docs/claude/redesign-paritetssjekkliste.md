...
| P31 | **Kontakter (NY lesevisning, K6-splitt)** — prosjektkontakter: faggrupper + folk m/ tlf/e-post, klikk-for-å-ringe på mobil | — (ny; data = samme query som dokumentflyt-siden) | **sidebar-P + søk + mobil Mer-tab** | `kreverProsjekt` | Nei | |
