...
- **Neste milepæl:** Gjenstår i handoff: steg viii (sammenligningsrunde mot prod-kopi m/ kunde) — **drift-runde (Kenneth)** per [steg-viii-kunderunde.md](../redesign/steg-viii-kunderunde.md). **Bruker-lagret flagg (Plan 2) ✅ SLUTTGODKJENT + LUKKET (fabel, 2026-07-07):** merget develop (`0d3f21ac` + SecureStore-fix `19f7cdcb`); presedens **aktiv `?nyNav`-URL (flyktig) > konto > persistert lokal > env-default > av** (13/13 test); web-bevis a–d (Opus web) + simulator-bevis (brukerbytte uten restart + offline-fallback, `docs/redesign/screenshots/plan2-simulator-2026-07-07/`) godkjent. SecureStore-kolon-bug fanget + fikset under beviset.
