...
- **Neste milepæl:** Gjenstår i handoff: steg viii (sammenligningsrunde mot prod-kopi m/ kunde) + pilot-plan (flagg → company_admin). Åpen Kenneth-beslutning: enhets- vs bruker-lagret `nyNavigasjon`-flagg før pilot (BACKLOG).
