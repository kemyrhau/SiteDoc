...
- **Neste milepæl:** Gjenstår i handoff: steg viii (sammenligningsrunde mot prod-kopi m/ kunde). **Bruker-lagret flagg ✅ bygget (Plan 2, 2026-07-07)** — pilot-blokkeren (enhets- vs bruker-lagret) er lukket; venter bevisrunde (web flagg-atferd + simulator brukerbytte) → dual-review → merge m/ schema-varsel til cowork. Steg viii-infra (redesign-stack) ligger i [steg-viii-kunderunde.md](../redesign/steg-viii-kunderunde.md).
