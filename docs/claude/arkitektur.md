...
| `ftd_document_chunks` | Søkbare tekstbiter med tsvector (norsk stemming, GIN), NS-koder, sideinfo. OCR-fallback for skannede PDFer (pdftoppm+tesseract). Excel: richText/formel-håndtering |
