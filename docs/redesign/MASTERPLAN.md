...
| P1 | Nivåsignal firma vs. prosjekt (prod-funn 2026-07-21) | **A+B+C merget (`9383233b`) + på test.** Rekkefølge: designgate på A+B+C → **K1+K2** → **[K3](../claude/delplaner/k3-kontekstvelger-vedtak.md)**. ⚠️ **Uavklart:** er K3 P1s siste revisjon (P1 lukkes etter K3 — Kenneth) eller egen sak (P1 lukkes nå — fabel)? **Venter fabel.** Chip-innhold-avviket (nivåord vs. navn) rettes i K3 uansett. Fasit-bilder: `docs/redesign/fasit/`. Utenfor kjeden: [P1d suffiks](../claude/delplaner/p1d-suffiks-innstilling-sak.md) | `verifisering/p1-nivasignal-verifiseringslogg.md` |
