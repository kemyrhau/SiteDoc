...
| 6b | Sjekklister/Oppgaver/HMS/Kontrollplan | **Delplan vedtatt 2026-07-16** (`delplaner/del6b-delplan.md`, 4 faser + fase M; Kenneth-vedtak: mobil bygges her, kontrollplan-bro = ønsket funksjon, ambisjon a først). Bug-klasse rutet til develop: `delplaner/del6b-develop-bugordre.md`. Nå-rapport levert (repo-rot) | `verifisering/del6b-verifiseringslogg.md` (opprettes ved fase 1) |
...
| P1 | Nivåsignal firma vs. prosjekt (prod-funn 2026-07-21: firma-/prosjekt-HMS forvekslbare) | Vedtatt 2026-07-21 (1c + klikkbar chip-snarvei, K5 bevart) — ordre klar: `delplaner/p1-nivasignal-ordre.md` (nå-rapport = ledd 1). Scope nå: HMS-paret; gjennomgående plan for alle par = egen sak etter delplan. Oppfølgere: K1+K2 (liten sak, fabel-gatet) · **K3 kontekstvelger-trakt DESIGN LÅST 2026-07-21** (`delplaner/k3-kontekstvelger-vedtak.md`, fasit § 3a i beslutningskartet) · P1d suffiks (repo-sak) | `verifisering/p1-nivasignal-verifiseringslogg.md` (opprettes) |
...
1. **Del 6b Sjekklister/Oppgaver/HMS** — fase 1-ordre klar, venter relay
...
4. **P1 nivåsignal** (ordre klar) → **P2 inndata-validering** (ordre etter P1-sekvensering)
...
2. Fabel/Kenneth: relay del 6b fase 1-ordre (`delplaner/del6b-fase1-ordre.md`) til redesign. Fase M-rekkefølge (Kenneth-vedtatt 2026-07-16, `delplaner/faseM-byggeregler-forslag.md`): M-3a develop-sak (decimal-UI/kollaps/kopiér) → M-3b bibliotek-arkitektur (nå-sjekk + skisse først) → M-4 én pilot-mal → M-5 produksjon del for del
