...
**Merknad:** Header-fix løser KUN rekkefølge + skjul firma-link for vanlig bruker + redirect til firma-admin. Den løser IKKE de to delfixene fra `427c2659`-notatet: (1) filtrering av prosjektliste på `primaryOrganizationId`, (2) auto-reset av aktivt prosjekt ved firma-bytte. De står fortsatt som planlagte oppgaver i STATUS-AKTUELT.md.
