...
**Status 2026-05-01:** Fase 0-koding **STARTET** på `feature/fase-0-fundament`. § E-fremdrift: E.1 Activity-tabell (`13a746a7`), E.2 OrganizationSetting (`4a155c28`), E.3 ProjectOrganization-rename + rolle (`1bff8672`), E.4 Project.primaryOrganizationId nullable (`137eed6f`), E.5 ProjectModule-utvidelse (`d9bfafc4` — organizationId + status 3-nivå per A.4/A.17), E.6 OrganizationPartner (`22a772b6` — firma-eid UE/byggherre/leverandør-bibliotek + Faggruppe.partnerId), E.7 OrganizationTemplate (`7709ea32` — firma-mal-bibliotek + ReportTemplate.organizationTemplateId/promotedToFirma), E.8 BibliotekMal-utvidelse ✅ (kategori/domene/kobletTilModul/verifisert — lukker P-KRITISK-3 hardkodings-drift). Ny åpen rad C.17 i fase-0-beslutninger.md: språkstøtte for BibliotekMal/OrganizationTemplate (besluttes Fase 2). E.10 ProjectMember.periodeSlutt 🔄. Timer/Maskin-revurdering utsatt til etter Fase 0-fundament er ferdig.
