...
| [docs/claude/fase-0-beslutninger.md](docs/claude/fase-0-beslutninger.md) | **🟢 KODING I GANG (2026-05-01):** 30 vedtatte beslutninger (§A) + 7 lukkede BLOKKERE (§B.1–B.7) + 14 anbefalte utvidelser (§C, inkl. C.17 språkstøtte åpen) + 14-stegs migrerings-rekkefølge (§E) + § F Fase 0.7 data-rens. **§ E-fremdrift:** E.1 Activity ✅, E.2 OrganizationSetting ✅, E.3 ProjectOrganization-rename ✅, E.4 primaryOrganizationId ✅ (`137eed6f`), E.5 ProjectModule-utvidelse ✅ (`d9bfafc4`), E.6 OrganizationPartner ✅ (`22a772b6`), E.7 OrganizationTemplate ✅ (`7709ea32`), E.8 BibliotekMal-utvidelse ✅ (`29311756`), E.10 ProjectMember.periodeSlutt + cascade SetNull + 3 loan-tabeller ✅ (`5b8beef6`), E.11 ExternalCostObject ✅ (`9c9dd682`), E.12 Godkjenning + DocumentTransfer ✅ (`0622fc35`), E.13 User-utvidelse + composite unique per B.7 ✅, E.14 OrganizationRole 🔄 (siste! på `feature/fase-0-fundament`) |
...
**Status 2026-05-01:** Fase 0-koding **STARTET** på `feature/fase-0-fundament`. § E-fremdrift: E.1 Activity-tabell (`13a746a7`), E.2 OrganizationSetting (`4a155c28`), E.3 ProjectOrganization-rename + rolle (`1bff8672`), E.4 Project.primaryOrganizationId nullable (`137eed6f`), E.5 ProjectModule-utvidelse (`d9bfafc4`), E.6 OrganizationPartner (`22a772b6`), E.7 OrganizationTemplate (`7709ea32`), E.8 BibliotekMal-utvidelse + C.17-notis (`29311756`), E.10 ProjectMember.periodeSlutt + userId cascade SetNull + 3 loan-tabeller (`5b8beef6`), E.11 ExternalCostObject (`9c9dd682`), E.12 Godkjenning + DocumentTransfer-utvidelse (`0622fc35`), E.13 User-utvidelse ✅ — canLogin/HMS-kort/ansattnummer/fødselsdato/nasjonalitet/arbeidstillatelse + drop email @unique → composite @@unique([email, organizationId]) + @@unique([phone, organizationId]) per B.7 + NextAuth-override (custom getUserByEmail med findFirst+canLogin+eldste-først) + 5 kode-fikser (medlem.ts/gruppe.ts/mobilAuth.ts findUnique→findFirst). Migrasjon m/duplikat-sjekk i SQL. E.9 hoppet over per § E. E.14 OrganizationRole 🔄 (siste). Timer/Maskin-revurdering utsatt til etter Fase 0-fundament er ferdig.
