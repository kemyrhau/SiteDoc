...
**Heatwork-seed + U6 maskin firma-kontekst-fix DEPLOYET TIL PROD 2026-05-06** (merge `3dd4371b`). U6 lukket: equipment-router har ny `hentMaskinOrgFraInput` + `verifiserMaskinTilgang` med sitedoc_admin-bypass; klient (maskin/page.tsx, maskin/nytt/page.tsx, maskin/[id]/page.tsx) sender `useFirma().valgtFirma?.id`. Heatwork-seed mot prod (`4488fe17-...`): `3 opprettet, 2 eksisterte`. **PRESISERT:** Idempotens-sjekken fant 7632 + 7634 fra SmartDok-import 2026-05-03 (`type=Anleggsmaskin`, `erUtleieobjekt=false`, `intern_navn=«7632 Heatwork 3600 (Tromsø)»`/«7634 Heatwork MY35 (Tromsø)»). De ble IKKE oppdatert siden scriptet kun oppretter, ikke overskriver. **Manuelt: endre 7632 og 7634 i UI** — sett `type=Heatwork 3600`/`Heatwork MY35`, `erUtleieobjekt=true`, `utleieEnhet=doegn`. 7626/7628/7630 ble korrekt opprettet med utleie-flagg. HTTP/2 200 mot sitedoc.no etter restart.
