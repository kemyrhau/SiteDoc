...
| [docs/claude/steg-4b-plan.md](docs/claude/steg-4b-plan.md) | **🟡 VEDTATT (2026-05-05):** Komplett implementasjonsplan for Vareforbruk-modul. Ny `db-varelager`-pakke. 7 beslutninger inkl. Heatwork-eksklusjon (Equipment-utleie i stedet) + ECO-kobling + fritekst-enhet. 5 faser, ~16t totalt, 3 sesjoner. A.Markussen-import: 58 varer fra SmartDok (64 minus 6 Heatwork). Equipment-utleie-utvidelse i Fase 2; full utleie-transaksjons-flow utsatt til Steg 4d |
...
**Steg 4b-plan VEDTATT 2026-05-05** — komplett implementasjonsplan i [docs/claude/steg-4b-plan.md](docs/claude/steg-4b-plan.md). Vareforbruk-modul: ny `db-varelager`-pakke, 5 faser ~16t, 3 sesjoner. Heatwork ekskluderes (håndteres via `Equipment.erUtleieobjekt`-flagg i Fase 2; full utleie-transaksjons-flow utsatt til Steg 4d). 58 varer importeres fra A.Markussen SmartDok-katalog. Forutsetning Steg 1e ✅ deployet prod 2026-05-05. Avventer eksplisitt grønt lys for implementering.
