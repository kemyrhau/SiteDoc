...
| [docs/claude/fase-0-beslutninger.md](docs/claude/fase-0-beslutninger.md) | **🟢 KODING I GANG (2026-05-01):** 30 vedtatte beslutninger (§A) + 7 lukkede BLOKKERE (§B.1–B.7) + 13 anbefalte utvidelser (§C) + 14-stegs migrerings-rekkefølge (§E) + § F Fase 0.7 data-rens. **§ E-fremdrift:** E.1 Activity ✅, E.2 OrganizationSetting ✅, E.3 ProjectOrganization-rename ✅, E.4 primaryOrganizationId ✅ (`137eed6f`), E.5 ProjectModule-utvidelse ✅ (`d9bfafc4`), E.6 OrganizationPartner ✅, E.7 OrganizationTemplate 🔄 (på `feature/fase-0-fundament`) |
...
**Status 2026-05-01:** Fase 0-koding **STARTET** på `feature/fase-0-fundament`. § E-fremdrift: E.1 Activity-tabell (`13a746a7`), E.2 OrganizationSetting (`4a155c28`), E.3 ProjectOrganization-rename + rolle (`1bff8672`), E.4 Project.primaryOrganizationId nullable (`137eed6f`), E.5 ProjectModule-utvidelse (`d9bfafc4` — organizationId + status 3-nivå per A.4/A.17, parallelt med `active` til steg 2 post-Fase 1), E.6 OrganizationPartner ✅ (firma-eid UE/byggherre/leverandør-bibliotek + Faggruppe.partnerId), E.7 OrganizationTemplate 🔄. Timer/Maskin-revurdering utsatt til etter Fase 0-fundament er ferdig.
