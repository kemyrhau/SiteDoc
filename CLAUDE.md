...
| [docs/claude/fase-0-beslutninger.md](docs/claude/fase-0-beslutninger.md) | **🟢 KODING I GANG (2026-05-01):** 30 vedtatte beslutninger (§A) + 7 lukkede BLOKKERE (§B.1–B.7) + 13 anbefalte utvidelser (§C) + 14-stegs migrerings-rekkefølge (§E) + § F Fase 0.7 data-rens. **§ E-fremdrift:** E.1 Activity ✅, E.2 OrganizationSetting ✅, E.3 ProjectOrganization-rename ✅, E.4 primaryOrganizationId ✅ (`137eed6f`), E.5 ProjectModule-utvidelse ✅ (`d9bfafc4`), E.6 OrganizationPartner ✅ (`22a772b6`), E.7 OrganizationTemplate ✅, E.8 BibliotekMal-utvidelse 🔄 (på `feature/fase-0-fundament`) |
