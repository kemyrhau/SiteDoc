...
**Status 2026-05-01:** Fase 0-koding **STARTET** på `feature/fase-0-fundament`. § E steg 1-4 i implementasjon: E.1 Activity-tabell (`13a746a7`), E.2 OrganizationSetting (`4a155c28`), E.3 ProjectOrganization-rename + rolle (`1bff8672`), E.4 Project.primaryOrganizationId nullable (i arbeid). Timer/Maskin-revurdering utsatt til etter Fase 0-fundament er ferdig.
