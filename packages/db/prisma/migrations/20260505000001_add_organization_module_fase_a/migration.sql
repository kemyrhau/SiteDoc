...
CREATE TABLE "organization_modules" (
  ...
  "aktivert_av_user_id"   UUID         NULL,
  "deaktivert_ved"        TIMESTAMP(3) NULL,
  "deaktivert_av_user_id" UUID         NULL,
  "config"                JSONB        NULL,
...
INSERT INTO "organization_modules"
  ("organization_id", "module_slug", "status", "aktivert_ved", "updated_at")
SELECT "id", 'timer', 'aktiv', "created_at", NOW()
FROM "organizations"
WHERE "har_timer_modul" = true;

INSERT INTO "organization_modules"
  ("organization_id", "module_slug", "status", "aktivert_ved", "updated_at")
SELECT "id", 'maskin', 'aktiv', "created_at", NOW()
FROM "organizations"
