...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "organization_integrations_organization_id_idx" ON "organization_integrations"("organization_id");

-- Faggruppe (dokumentflyt_parts): 3 FK — sentral i dokumentflyt + prosjekt-isolering
-- CreateIndex
CREATE INDEX IF NOT EXISTS "dokumentflyt_parts_project_id_idx" ON "dokumentflyt_parts"("project_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "dokumentflyt_parts_kontrakt_id_idx" ON "dokumentflyt_parts"("kontrakt_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "dokumentflyt_parts_ansvarlig_id_idx" ON "dokumentflyt_parts"("ansvarlig_id");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "drawings_byggeplass_id_idx" ON "drawings"("byggeplass_id");

-- PointCloud: FK projectId + byggeplassId — punktsky-oppslag per prosjekt/byggeplass
-- CreateIndex
CREATE INDEX IF NOT EXISTS "point_clouds_project_id_idx" ON "point_clouds"("project_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "point_clouds_byggeplass_id_idx" ON "point_clouds"("byggeplass_id");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "drawing_revisions_uploaded_by_id_idx" ON "drawing_revisions"("uploaded_by_id");

-- ProjectGroupMember: FK projectMemberId (groupId allerede i unique-constraint)
-- CreateIndex
CREATE INDEX IF NOT EXISTS "project_group_members_project_member_id_idx" ON "project_group_members"("project_member_id");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "group_faggrupper_faggruppe_id_idx" ON "group_faggrupper"("faggruppe_id");
