...
/**
 * KC3.1 «Oppstøtting av trær» — ÅTTE felt mot NS 3420-K post KC3.1 c1–c4 + KC3.11.
 *
 * Vedtak 2026-09-18 (docs/claude/domene-arbeidsflyt.md): en sjekkliste dokumenterer at
 * arbeidet er utført og objektet klart for overlevering. Kontrollpunkter som forutsetter
 * at tid har gått (f.eks. 1-årskontroll) hører til en ANNEN arbeidsoppgave og skal IKKE
 * inn. Derfor er sesongkontroll-feltet holdt ute; konklusjonen heter «Krav oppfylt og
...
describe("KC3.1 – 8 felt mot NS 3420-K", () => {
  ...
  it("grupperer feltene i FØR/UNDER/ETTER (ETTER bærer mengde + konklusjon)", () => {
