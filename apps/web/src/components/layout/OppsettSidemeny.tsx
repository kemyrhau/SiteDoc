...
/**
 * Native innstillings-sidemeny (uttrukket fra `oppsett/layout.tsx`, 2026-07-15).
 *
 * Uendret utseende, logikk og gating — kun flyttet til egen komponent så den
 * kan gjenbrukes av BÅDE oppsett-undersidene (`oppsett/layout.tsx`) OG
 * innstillinger-huben (`innstillinger/layout.tsx`) uten en parallell variant.
 * Aktiv-markering følger `pathname`: på hub-roten (`/dashbord/innstillinger`)
 * matcher ingen `oppsett/*`-href → ingen rad lyser (som ønsket).
 */
...
export function OppsettSidemeny() {
