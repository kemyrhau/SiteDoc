...
export interface ViewerAPI {
  ...
  /** Fly kamera til et 3D-punkt. gulvY = kalibrert gulvhøyde i modellen. Returnerer Promise som resolves når kamera har stoppet. */
  flyTil: (x: number, y: number, z: number, gulvY?: number) => Promise<void>;
