...
/**
 * Timer-hjem (firma). Var tidligere en `redirect()`-stub til .../onboarding;
 * flyttet hit (fabel-valgt struktur a) så /dashbord/firma/timer er en EKTE side.
 * Rotårsak: kryss-kontekst-⇄ (prosjekt→firma) til en redirect-rute avbryter
 * renderen (React #310) — HMS-⇄ virket fordi firma/HMS er ekte side. Ved å
 * gjøre timer-hjem ekte peker ⇄ ikke lenger på en redirect. Innholdet er
 * onboarding-/katalogstatus-visningen (uendret oppførsel).
 */
export default function TimerHjemSide() {
